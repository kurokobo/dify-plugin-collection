...
This plugin is designed to provide fake LLM models within Dify.
...
- User prompts and messages provided by the users
...
- To generate fake responses based on the provided prompts and messages
...
All responses are generated locally without any external communication.

### Data Retention and Management

This plugin does not request storage permissions.
The plugin does not independently store any prompts, messages, or data provided by the user on the local file system or any external servers.
All data is processed in-memory and discarded immediately after generating responses.
